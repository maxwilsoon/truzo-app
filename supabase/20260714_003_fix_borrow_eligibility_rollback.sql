-- Rollback: Revert borrow eligibility fix
-- NOTE: This cannot restore the exact pre-migration borrowed values.
-- It recreates the original create_money_request without the duplicate-borrow guard.
